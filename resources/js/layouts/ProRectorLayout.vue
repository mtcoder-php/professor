    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        >
            ...
            <nav class="p-4 space-y-2 overflow-y-auto h-[calc(100vh-180px)]">
                ...
                <!-- Profile ← YANGI -->
                <router-link to="/prorektor/profile" class="sidebar-link" active-class="sidebar-link-active">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="relative" v-click-outside="closeDropdown">
                                ...
                                <transition enter-active-class="transition ease-out duration-100" enter-from-class="transform opacity-0 scale-95" enter-to-class="transform opacity-100 scale-100" leave-active-class="transition ease-in duration-75" leave-from-class="transform opacity-100 scale-100" leave-to-class="transform opacity-0 scale-95">
                                    <div v-if="dropdownOpen" class="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50">
                                        ...
                                        <!-- Profile Link ← YANGI -->
                                        <router-link to="/prorektor/profile" @click="dropdownOpen = false" class="dropdown-item">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                            </svg>
                                            <span>Profil</span>
